...
parser.add_argument('--doAttention', nargs='+', type=lambda x: (str(x).lower() == 'true'), default=[True, False, False])
parser.add_argument('--AttentionType', default='concat', type=str, choices=['concat','dot', 'NoAttention'],help='type of the invertible attention embedded')
...
parser.add_argument('--use_label', default=False, type=bool, help='Whether use label information')
...
def main():
    ...
    def get_model(args):
        model = multiscale_iResNet(in_shape,
                                    args.nBlocks, args.nStrides, args.nChannels, args.doAttention, args.AttentionType,
                                    args.init_ds == 2,
                                    args.coeff,
                                    args.nClasses, 
